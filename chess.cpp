...
{		//(Piece Type, Side Black, init x(default 0), init y(default 0))
	...
	while (true){
		...
		switch(movTo[0])
		{
			case 'A':	xCoord = 1;	break;
			case 'B':	xCoord = 2;	break;
			case 'C':	xCoord = 3;	break;
			case 'D':	xCoord = 4;	break;
			case 'E':	xCoord = 5;	break;
			case 'F':	xCoord = 6;	break;
			case 'G':	xCoord = 7;	break;
			case 'H':	xCoord = 8;	break;
		}

		switch(movTo[1])
		{
			case '1':	yCoord = 1;	break;
			case '2':	yCoord = 2;	break;
			case '3':	yCoord = 3;	break;
			case '4':	yCoord = 4;	break;
			case '5':	yCoord = 5;	break;
			case '6':	yCoord = 6;	break;
			case '7':	yCoord = 7;	break;
			case '8':	yCoord = 8;	break;
		}
		
		switch(movTo[3])
		{
			case 'A':	xCoord2 = 1;	break;
			case 'B':	xCoord2 = 2;	break;
			case 'C':	xCoord2 = 3;	break;
			case 'D':	xCoord2 = 4;	break;
			case 'E':	xCoord2 = 5;	break;
			case 'F':	xCoord2 = 6;	break;
			case 'G':	xCoord2 = 7;	break;
			case 'H':	xCoord2 = 8;	break;
		}

		switch(movTo[4])
		{
			case '1':	yCoord2 = 1;	break;
			case '2':	yCoord2 = 2;	break;
			case '3':	yCoord2 = 3;	break;
			case '4':	yCoord2 = 4;	break;
			case '5':	yCoord2 = 5;	break;
			case '6':	yCoord2 = 6;	break;
			case '7':	yCoord2 = 7;	break;
			case '8':	yCoord2 = 8;	break;
		}
		//cin>>xCoord;
		//cin>>yCoord;
		//cin>>xCoord2;
